  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[var(--amline-bg)] p-4 py-10">
      <div className="mx-auto max-w-lg rounded-2xl border border-[var(--amline-border)] bg-[var(--amline-surface)] p-8 shadow-lg">
        <h1 className="mb-1 text-xl font-bold text-[var(--amline-primary)]">ثبت‌نام مشاور املاین</h1>
        ...
        <div className="space-y-3">
          {(
            ...
            <div key={k}>
              ...
              <input
                className="w-full rounded-lg border border-[var(--amline-border)] px-3 py-2 text-sm dark:bg-slate-900"
                value={form[k]}
                onChange={set(k)}
        ...
        <button
          ...
          onClick={() => m.mutate()}
          className="mt-6 w-full rounded-lg bg-[var(--amline-primary)] py-2.5 text-sm font-medium text-white disabled:opacity-50"
        >
          ارسال برای بررسی
        </button>
