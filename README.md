...
> **آماده‌سازی برای کاربر نهایی (پلن اجرایی و برید باریک):** [`docs/PRODUCT_READINESS_EXECUTION_PLAN.md`](docs/PRODUCT_READINESS_EXECUTION_PLAN.md) — **بک‌لاگ استوری‌ها و معیار پذیرش:** [`docs/GO_LIVE_SPRINT_BACKLOG.md`](docs/GO_LIVE_SPRINT_BACKLOG.md) — مرز v1 و چک‌لیست go-live: [`docs/PLATFORM_GO_LIVE_ROADMAP.md`](docs/PLATFORM_GO_LIVE_ROADMAP.md).
