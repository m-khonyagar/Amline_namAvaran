...
> **آماده‌سازی برای کاربر نهایی (پلن اجرایی و برید باریک):** [`docs/PRODUCT_READINESS_EXECUTION_PLAN.md`](docs/PRODUCT_READINESS_EXECUTION_PLAN.md) — **بک‌لاگ استوری‌ها و معیار پذیرش:** [`docs/GO_LIVE_SPRINT_BACKLOG.md`](docs/GO_LIVE_SPRINT_BACKLOG.md) — **GitHub (قالب Issue، برچسب، milestone):** [`docs/GITHUB_GO_LIVE.md`](docs/GITHUB_GO_LIVE.md) — [Milestone Go-Live v1](https://github.com/m-khonyagar/Amline_namAvaran/milestone/1) — مرز v1 و چک‌لیست go-live: [`docs/PLATFORM_GO_LIVE_ROADMAP.md`](docs/PLATFORM_GO_LIVE_ROADMAP.md) — **دیپلوی سرور:** [`docs/SERVER_DEPLOY_CHECKLIST.md`](docs/SERVER_DEPLOY_CHECKLIST.md).
...
npm run local:preview   # mock :8080 + ادمین ۳۰۰۲ + اپ ۳۰۰۰ + مشاور ۳۰۰۴ + سایت ۳۰۰۵ (چند پنجره)
