...
# DB-backed wizard (validation + parity with OpenAPI) — register before v1 in-memory flow so paths match first.
platform_router.include_router(legacy_contract_wizard.router, prefix="/contracts")
