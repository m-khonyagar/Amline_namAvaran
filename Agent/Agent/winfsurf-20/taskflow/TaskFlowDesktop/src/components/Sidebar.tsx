  ...
  return (
    ...
    >
        ...
        {!collapsed && (
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-muted-foreground truncate leading-tight">AI Developer Tool</p>
            </div>
          </div>
        )}
        <button
      ...
      {!collapsed && (
        <div className="px-2 py-2.5 border-b soft-divider">
          <button
            ...
            className="btn-primary w-full justify-center text-[13px] h-9"
          >
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                {!collapsed && <span className="truncate flex-1 text-left text-[13px] font-medium">{item.label}</span>}
              </button>
            );
          })}
        </div>
      ...
      <div className="px-2 py-2.5 border-t soft-divider">
        <div className={`surface-elevated px-2.5 py-2 flex items-center gap-2 ${collapsed ? 'justify-center px-0' : ''}`}>
          <span className="w-1.5 h-1.5 rounded-full bg-success animate-pulse shrink-0" />
          {!collapsed && <span className="text-[11px] text-muted-foreground">{t('systemHealthy')}</span>}
        </div>
      </div>
    </aside>
  );
